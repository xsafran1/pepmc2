// Generated by Bisonc++ V2.09.03 on Mon, 28 Apr 2014 20:41:45 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {289, 2}, // 29: const_value ('-') ->  '-' NUMBER
     {275, 3}, // 30: thres_defs (':') ->  thres_name ':' thres_values
     {290, 1}, // 31: thres_name (NAME) ->  NAME
     {291, 1}, // 32: thres_values (NUMBER) ->  NUMBER
     {291, 3}, // 33: thres_values (',') ->  thres_values ',' NUMBER
     {274, 1}, // 34: var_defs (NAME) ->  NAME
     {274, 3}, // 35: var_defs (',') ->  var_defs ',' NAME
     {273, 1}, // 36: param_defs ->  param_def
     {273, 3}, // 37: param_defs (';') ->  param_defs ';' param_def
     {292, 3}, // 38: param_def (',') ->  param_name ',' param_interval
     {294, 3}, // 39: param_interval (',') ->  param_value ',' NUMBER
     {294, 4}, // 40: param_interval (',') ->  param_value ',' '-' NUMBER
     {293, 1}, // 41: param_name (NAME) ->  NAME
     {295, 1}, // 42: param_value (NUMBER) ->  NUMBER
     {295, 2}, // 43: param_value ('-') ->  '-' NUMBER
     {272, 3}, // 44: eq_defs ('=') ->  eq_var '=' expr
     {296, 1}, // 45: eq_var (NAME) ->  NAME
     {298, 1}, // 46: ap (NUMBER) ->  NUMBER
     {298, 1}, // 47: ap (NAME) ->  NAME
     {298, 1}, // 48: ap (RAMP) ->  RAMP
     {298, 1}, // 49: ap (SIGM) ->  SIGM
     {298, 1}, // 50: ap (STEP) ->  STEP
     {298, 2}, // 51: ap ('-') ->  '-' NUMBER
     {298, 2}, // 52: ap ('-') ->  '-' NAME
     {298, 2}, // 53: ap ('-') ->  '-' RAMP
     {298, 2}, // 54: ap ('-') ->  '-' SIGM
     {298, 2}, // 55: ap ('-') ->  '-' STEP
     {297, 1}, // 56: expr ->  summation
     {297, 1}, // 57: expr ->  ap
     {299, 1}, // 58: summation ->  summant
     {299, 3}, // 59: summation ('+') ->  summation '+' summant
     {299, 3}, // 60: summation ('-') ->  summation '-' summant
     {300, 1}, // 61: summant ->  multiplication
     {300, 1}, // 62: summant ->  parenthesis
     {301, 1}, // 63: multiplication ->  multiple
     {301, 3}, // 64: multiplication ('*') ->  multiplication '*' multiple
     {303, 1}, // 65: multiple ->  ap
     {303, 1}, // 66: multiple ->  parenthesis
     {302, 3}, // 67: parenthesis ('(') ->  '(' expr ')'
     {304, 1}, // 68: start_$ ->  start
};
...
{
    { { REQ_TOKEN}, {  4} },                     
    { {       281}, { 80} }, // var_points_values
    { {       282}, { 81} }, // var_points_value 
    { {       266}, { 82} }, // NUMBER           
    { {         0}, {  0} },                     
};
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 50:
        {
         ...
         if(title.compare(1,1,"p") == 0) {
         ent.PutHp(params.at(0),params.at(1),params.at(2),params.at(3),params.at(4));
         } else {
         ent.PutHm(params.at(0),params.at(1),params.at(2),params.at(3),params.at(4));
         }
         eq.push(ent);
         }
         }
