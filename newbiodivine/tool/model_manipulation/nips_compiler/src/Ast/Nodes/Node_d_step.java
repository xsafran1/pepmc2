...
public class Node_d_step extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_d_step( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_d_step( Attr_line, Attr_column );
  }
