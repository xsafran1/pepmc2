...
public class Node_arrow_colon extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_arrow_colon( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_arrow_colon( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_arrow_colon( this );
  }
}
