...
public class Node_sub extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_sub( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_sub( Attr_line, Attr_column );
  }
