...
public class Node_gt extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_gt( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_gt( Attr_line, Attr_column );
  }
