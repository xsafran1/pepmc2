...
public class Node_nr_pr extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_nr_pr( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_nr_pr( Attr_line, Attr_column );
  }
