...
public class Node_underscore_assign extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_underscore_assign( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_underscore_assign( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_underscore_assign( this );
  }
}
