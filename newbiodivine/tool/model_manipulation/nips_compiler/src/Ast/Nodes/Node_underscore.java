...
public class Node_underscore extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_underscore( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_underscore( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_underscore( this );
  }
}
