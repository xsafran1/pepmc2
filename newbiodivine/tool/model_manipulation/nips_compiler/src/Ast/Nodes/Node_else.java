...
public class Node_else extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_else( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_else( Attr_line, Attr_column );
  }
