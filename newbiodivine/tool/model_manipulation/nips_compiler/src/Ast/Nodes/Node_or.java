...
public class Node_or extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_or( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_or( Attr_line, Attr_column );
  }
