...
public class Node_label extends Node_stmnt
{
  private String Attr_line;
  private String Attr_name;
  private String Attr_column;

  public Node_label( String Attr_line, String Attr_name, String Attr_column )
  {
  ...
  {
    return new Node_label( Attr_line, Attr_name, Attr_column );
  }
