...
public class Node_neq extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_neq( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_neq( Attr_line, Attr_column );
  }
