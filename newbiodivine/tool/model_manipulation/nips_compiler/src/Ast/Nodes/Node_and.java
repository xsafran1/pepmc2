...
public class Node_and extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_and( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_and( Attr_line, Attr_column );
  }
