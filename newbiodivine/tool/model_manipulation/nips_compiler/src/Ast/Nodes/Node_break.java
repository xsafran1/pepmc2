...
public class Node_break extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_break( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_break( Attr_line, Attr_column );
  }
