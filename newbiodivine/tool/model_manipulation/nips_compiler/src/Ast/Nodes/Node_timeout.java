...
public class Node_timeout extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_timeout( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_timeout( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_timeout( this );
  }
}
