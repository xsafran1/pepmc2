...
public class Node_add extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_add( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_add( Attr_line, Attr_column );
  }
