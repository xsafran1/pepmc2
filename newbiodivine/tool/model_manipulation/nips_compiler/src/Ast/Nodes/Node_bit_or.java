...
public class Node_bit_or extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_bit_or( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_bit_or( Attr_line, Attr_column );
  }
