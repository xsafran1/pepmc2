...
public class Node_lt extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_lt( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_lt( Attr_line, Attr_column );
  }
