...
public class Node_bit_and extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_bit_and( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_bit_and( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_bit_and( this );
  }
}
