...
public class Node_xs extends Node_step
{
  private String Attr_line;
  private String Attr_column;

  public Node_xs( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_xs( Attr_line, Attr_column );
  }
