...
public class Node_if extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_if( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_if( Attr_line, Attr_column );
  }
