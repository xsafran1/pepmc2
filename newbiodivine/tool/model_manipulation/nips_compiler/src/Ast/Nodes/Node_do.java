...
public class Node_do extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_do( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_do( Attr_line, Attr_column );
  }
