...
public class Node_len extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_len( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_len( Attr_line, Attr_column );
  }
