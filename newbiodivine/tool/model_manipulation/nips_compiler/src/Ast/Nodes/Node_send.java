...
public class Node_send extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;
  private String Attr_type;

  public Node_send( String Attr_line, String Attr_column, String Attr_type )
  {
  ...
  {
    return new Node_send( Attr_line, Attr_column, Attr_type );
  }
