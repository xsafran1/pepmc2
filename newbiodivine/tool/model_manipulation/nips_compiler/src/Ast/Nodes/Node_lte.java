...
public class Node_lte extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_lte( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_lte( Attr_line, Attr_column );
  }
