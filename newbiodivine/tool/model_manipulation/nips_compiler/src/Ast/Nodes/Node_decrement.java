...
public class Node_decrement extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_decrement( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_decrement( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_decrement( this );
  }
}
