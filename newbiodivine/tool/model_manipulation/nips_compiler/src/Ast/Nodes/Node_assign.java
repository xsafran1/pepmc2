...
public class Node_assign extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_assign( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_assign( Attr_line, Attr_column );
  }
