...
public class Node_trace extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_trace( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_trace( Attr_line, Attr_column );
  }
