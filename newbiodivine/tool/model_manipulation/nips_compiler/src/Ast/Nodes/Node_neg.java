...
public class Node_neg extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_neg( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_neg( Attr_line, Attr_column );
  }
