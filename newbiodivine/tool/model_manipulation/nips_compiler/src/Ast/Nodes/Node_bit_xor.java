...
public class Node_bit_xor extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_bit_xor( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_bit_xor( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_bit_xor( this );
  }
}
