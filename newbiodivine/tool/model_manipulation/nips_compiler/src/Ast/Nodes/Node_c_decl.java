...
public class Node_c_decl extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_c_decl( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_c_decl( Attr_line, Attr_column );
  }
