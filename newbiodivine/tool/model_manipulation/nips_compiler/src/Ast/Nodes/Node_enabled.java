...
public class Node_enabled extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_enabled( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_enabled( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_enabled( this );
  }
}
