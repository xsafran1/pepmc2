...
public class Node_tilde extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_tilde( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_tilde( Attr_line, Attr_column );
  }
