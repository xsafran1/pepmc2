...
public class Node_block extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_block( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_block( Attr_line, Attr_column );
  }
