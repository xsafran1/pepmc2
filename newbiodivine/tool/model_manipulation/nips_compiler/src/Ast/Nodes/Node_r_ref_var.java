...
public class Node_r_ref_var extends Node_expr
{
  ...
  public Node_r_ref_var( String Attr_line, String Attr_proc, String Attr_name, String Attr_column )
  {
  ...
  {
    return new Node_r_ref_var( Attr_line, Attr_proc, Attr_name, Attr_column );
  }
  ...
  {
    visitor.visitNode_r_ref_var( this );
  }
}
