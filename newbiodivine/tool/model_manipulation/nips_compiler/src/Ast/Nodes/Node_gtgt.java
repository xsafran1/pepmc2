...
public class Node_gtgt extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_gtgt( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_gtgt( Attr_line, Attr_column );
  }
