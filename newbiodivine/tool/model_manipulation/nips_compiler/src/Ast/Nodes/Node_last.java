...
public class Node_last extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_last( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_last( Attr_line, Attr_column );
  }
