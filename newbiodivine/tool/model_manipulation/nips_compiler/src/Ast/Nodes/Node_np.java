...
public class Node_np extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_np( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_np( Attr_line, Attr_column );
  }
