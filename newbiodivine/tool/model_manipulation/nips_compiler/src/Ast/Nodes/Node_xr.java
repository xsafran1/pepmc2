...
public class Node_xr extends Node_step
{
  private String Attr_line;
  private String Attr_column;

  public Node_xr( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_xr( Attr_line, Attr_column );
  }
