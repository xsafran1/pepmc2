...
public class Node_option extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_option( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_option( Attr_line, Attr_column );
  }
