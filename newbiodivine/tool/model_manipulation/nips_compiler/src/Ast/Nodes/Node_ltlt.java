...
public class Node_ltlt extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_ltlt( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_ltlt( Attr_line, Attr_column );
  }
