...
public class Node_c_code extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_c_code( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_c_code( Attr_line, Attr_column );
  }
