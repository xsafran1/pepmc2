...
public class Node_eq extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_eq( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_eq( Attr_line, Attr_column );
  }
