...
public class Node_mod extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_mod( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_mod( Attr_line, Attr_column );
  }
