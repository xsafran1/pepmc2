...
public class Node_div extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_div( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_div( Attr_line, Attr_column );
  }
