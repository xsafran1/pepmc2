...
public class Node_notrace extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_notrace( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_notrace( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_notrace( this );
  }
}
