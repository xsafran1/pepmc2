...
public class Node_enabler extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_enabler( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_enabler( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_enabler( this );
  }
}
