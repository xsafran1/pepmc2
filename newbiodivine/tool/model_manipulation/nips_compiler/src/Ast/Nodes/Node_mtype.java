...
public class Node_mtype extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_mtype( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_mtype( Attr_line, Attr_column );
  }
