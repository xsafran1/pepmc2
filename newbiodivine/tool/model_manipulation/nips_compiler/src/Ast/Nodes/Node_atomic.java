...
public class Node_atomic extends Node_stmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_atomic( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_atomic( Attr_line, Attr_column );
  }
