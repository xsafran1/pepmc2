...
public class Node_varref extends Node_expr
{
  private String Attr_line;
  private String Attr_name;
  private String Attr_column;

  public Node_varref( String Attr_line, String Attr_name, String Attr_column )
  {
  ...
  {
    return new Node_varref( Attr_line, Attr_name, Attr_column );
  }
