...
public class Node_excl extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_excl( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_excl( Attr_line, Attr_column );
  }
