...
public class Node_c_assert extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_c_assert( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_c_assert( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_c_assert( this );
  }
}
