...
public class Node_assert extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_assert( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_assert( Attr_line, Attr_column );
  }
