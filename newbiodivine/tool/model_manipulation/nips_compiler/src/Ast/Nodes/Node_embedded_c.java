...
public class Node_embedded_c extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_embedded_c( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_embedded_c( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_embedded_c( this );
  }
}
