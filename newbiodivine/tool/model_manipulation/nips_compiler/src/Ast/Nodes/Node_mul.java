...
public class Node_mul extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_mul( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_mul( Attr_line, Attr_column );
  }
