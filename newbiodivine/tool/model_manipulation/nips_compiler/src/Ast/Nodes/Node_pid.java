...
public class Node_pid extends Node_expr
{
  private String Attr_line;
  private String Attr_column;

  public Node_pid( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_pid( Attr_line, Attr_column );
  }
