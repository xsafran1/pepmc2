...
public class Node_eval extends Node
{
  private String Attr_line;
  private String Attr_column;

  public Node_eval( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_eval( Attr_line, Attr_column );
  }
