...
public class Node_increment extends Node_sstmnt
{
  private String Attr_line;
  private String Attr_column;

  public Node_increment( String Attr_line, String Attr_column )
  {
  ...
  {
    return new Node_increment( Attr_line, Attr_column );
  }
  ...
  {
    visitor.visitNode_increment( this );
  }
}
