...
<!-- generated with COPASI 4.4 (Build 26) (http://www.copasi.org) at 2009-04-23 16:54:18 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="26">
  ...
  <Model key="Model_0" name="Demo model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="r1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_79" name="k1" value="0.5"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+21 3.613284900000001e+21 1.2044283e+21 1
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="1"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="1"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=InitialConcentration"/>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[A]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Demo model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[B]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Demo model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[C]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Demo model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Demo model,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
