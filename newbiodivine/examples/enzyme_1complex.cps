...
<!-- generated with COPASI 4.4 (Build 26) (http://www.copasi.org) at 2009-04-02 09:33:28 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="26">
  <ListOfFunctions>
    ...
    <Function key="Function_44" name="Objective Function 1" type="Expression">
      <Expression>
    ...
    <Function key="Function_46" name="Objective Function 2" type="Expression">
      <Expression>
        
      </Expression>
    </Function>
  </ListOfFunctions>
  <Model key="Model_1" name="Michaelis Menten" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
    ...
    <ListOfReactions>
      ...
      <Reaction key="Reaction_1" name="r1 (forward)" reversible="false">
        <ListOfSubstrates>
      ...
      <Reaction key="Reaction_2" name="r1 (backward)" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_2" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfProducts>
    ...
    <InitialState type="initialState">
      0 6.022141499999995e+22 3.011070749999997e+22 0 0 1
    </InitialState>
  </Model>
  <ListOfTasks>
    <Task key="Task_10" name="Steady-State" type="steadyState" scheduled="false" updateModel="false">
      ...
      <Method name="Enhanced Newton" type="EnhancedNewton">
        ...
        <Parameter name="Derivation Factor" type="unsignedFloat" value="0.0001"/>
    ...
    <Task key="Task_11" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      <Problem>
        <Parameter name="StepNumber" type="unsignedInteger" value="201"/>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=InitialConcentration"/>
            <Parameter name="Minimum" type="float" value="25"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[E],Reference=InitialConcentration"/>
            <Parameter name="Minimum" type="float" value="95"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[ES],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=InitialConcentration"/>
            <Parameter name="Minimum" type="float" value="0.01"/>
    ...
    <Task key="Task_19" name="Moieties" type="moieties" scheduled="false" updateModel="false">
      <Problem>
      </Problem>
  ...
  <ListOfPlots>
    <PlotSpecification name="Dynamics" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[S]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[E]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[E],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[ES]|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[ES],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[P]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="Phase portrait E(S(t))" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[E]|[S]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
    ...
    <PlotSpecification name="Phase portrait P(E(t))" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[P]|[E]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Michaelis Menten,Vector=Compartments[compartment],Vector=Metabolites[E],Reference=Concentration"/>
