...
<!-- generated with COPASI 4.4 (Build 26) (http://www.copasi.org) at 2009-04-29 13:45:11 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="26">
  <ListOfFunctions>
    ...
    <Function key="Function_49" name="Objective Function 3" type="Expression">
      <Expression>
  ...
  <Model key="Model_1" name="New Model" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_0" name="C" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_6" name="D" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfReactions>
      <Reaction key="Reaction_0" name="r1" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_106" name="k1" value="0.1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="reaction" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_105" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">
      0 6.022141500000001e+21 6.022141500000001e+21 6.022141500000002e+16 6.022141500000002e+16 1
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=InitialConcentration"/>
            <Parameter name="Minimum" type="float" value="7"/>
            <Parameter name="Maximum" type="float" value="10"/>
            <Parameter name="log" type="bool" value="0"/>
          </ParameterGroup>
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[D],Reference=InitialConcentration"/>
            <Parameter name="Minimum" type="float" value="0.0001"/>
            <Parameter name="Maximum" type="float" value="3"/>
            <Parameter name="log" type="bool" value="0"/>
          </ParameterGroup>
    ...
    <Task key="Task_14" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="ObjectiveFunction" type="key" value="Function_49"/>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="Phase space AC" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[C]|[A]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
    ...
    <PlotSpecification name="Phase space AD" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[D]|[A]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
