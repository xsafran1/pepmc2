...
<!-- generated with COPASI 4.4.29 (development) (http://www.copasi.org) at 2009-07-13 17:33:40 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="29">
  ...
  <Model key="Model_1" name="Linear" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
    ...
    <ListOfReactions>
      ...
      <Reaction key="Reaction_1" name="r2" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_86" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_2" name="r3" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_91" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
    ...
    <InitialState type="initialState">
      0 0 1.505535375e+21 3.011070750000001e+21 1
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=InitialConcentration"/>
          ...
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="3"/>
            <Parameter name="Type" type="unsignedInteger" value="1"/>
            <Parameter name="Object" type="cn" value="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=InitialConcentration"/>
    ...
    <Task key="Task_20" name="Moieties" type="moieties" scheduled="false" updateModel="false">
      <Problem>
      </Problem>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[A]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Linear,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[A],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[B]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Linear,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[C]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Linear,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[C],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    ...
    <PlotSpecification name="CB" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[C]|[B]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Linear,Vector=Compartments[compartment],Vector=Metabolites[B],Reference=Concentration"/>
