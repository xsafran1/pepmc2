...
<!-- generated with COPASI 4.4 (Build 26) (http://www.copasi.org) at 2009-03-17 16:13:13 UTC -->
<COPASI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.copasi.org/static/schema.xsd" versionMajor="1" versionMinor="0" versionDevel="26">
  ...
  <Model key="Model_1" name="Minimal Oscillator [BAYRAMOV (14)]" timeUnit="s" volumeUnit="ml" quantityUnit="mmol" type="deterministic">
    <Comment>
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_2" name="x" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_1" name="y" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
      <Metabolite key="Metabolite_0" name="z" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfReactions>
      <Reaction key="Reaction_4" name="r1" reversible="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_101" name="k1" value="200"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_3" name="r2" reversible="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_2" stoichiometry="1"/>
          <Substrate metabolite="Metabolite_1" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
          <Constant key="Parameter_102" name="k1" value="5500"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_2" name="r3" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_103" name="k1" value="5"/>
        </ListOfConstants>
        <KineticLaw function="Function_13">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_81">
      ...
      <Reaction key="Reaction_1" name="r4" reversible="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_2" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_124" name="v" value="0.0005"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_0" name="r5" reversible="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_0" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_111" name="v" value="0.0001"/>
        </ListOfConstants>
        <KineticLaw function="Function_6">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
    ...
    <InitialState type="initialState">
      0 4.817713200000002e+16 1.32487113e+18 1.385092545e+17 1
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Reactions[r4],ParameterGroup=Parameters,Parameter=v,Reference=Value"/>
            <Parameter name="Minimum" type="float" value="1e-07"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[x]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[y]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[z]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Compartments[compartment],Vector=Metabolites[z],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="XY" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
    ...
    <PlotSpecification name="YZ" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[z]|[y]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration"/>
    ...
    <PlotSpecification name="XZ" type="Plot2D" active="1">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[z]|[x]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Minimal Oscillator \[BAYRAMOV (14)\],Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration"/>
